...
public upload = multer({ storage : multer.diskStorage({})})
  ...
  private initializeRoutes() {
   // admin
    ...
    this.router.post(`${this.path}/admin/update/:id`,this.upload.array("photo"), validationMiddleware(CreateProductImageDto, 'body', false), authorizeRoles([ROLE.ADMIN]), this.productImageController.updateProductImage);
